...
public class Oauth2TokenService {
	...
	private OAuth2AccessToken refreshedAccessToken() {
		...
		clientService.removeAuthorizedClient(oldClient.getClientRegistration().getRegistrationId(),
	...
	OAuth2AuthorizedClient getOAuth2AuthorizedClient() {
		...
		log.debug("Get OAuth2AuthorizedClient ({},{})", registrationId, name);
		OAuth2AuthorizedClient client = clientService.loadAuthorizedClient(registrationId, name);
		log.debug("Get OAuth2AuthorizedClient ({},{}) => {}", registrationId, name, client);
